				...
				if(sec2.length==0)
					{
						...
						tiempoCargar=setTimeout(cargar,1000); //Dispara la funcion cargar despues de x segundo.
					}
				else
					{
						tiempo=setTimeout(perder, 8000);//Reinicia la cuenta del tiempo y si termina, se dispara la funcion perder. -- aprox 4 MIN
					}
			}
				...
				if (ban==1)
					{
                        ...
                        h2.innerHTML= "Ups, tendrás que tomar ! "
						ini.value="Reiniciar"; 
					}
			}
		function sonido(url)
